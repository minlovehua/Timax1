...
public class MainActivity extends AppCompatActivity implements EventAdapter.IonLeftSlideViewClickListener{
    ...
    public void onSetBtnCilck(View view, int position) {
        makeText(MainActivity.this,"请设置",Toast.LENGTH_LONG).show();
    }
