...
public class CustomDatePicker {
    ...
    /**
     *对自定义控件的初始化以及一些参数的设置，其中关键的是一个构造方法和两个设置显示效果的方法。
     * @param context           Activity的Context
     * @param resultHandler     回调结果的接口，通过该接口可以把选中的时间发送给当前 Activity
     * @param startDate         该日期控件允许选择的范围的起始时间
     * @param endDate           该日期控件允许选择的范围的结束时间
     */
